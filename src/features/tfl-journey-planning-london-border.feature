...
Feature: TFL journey planner Request, with London border : StopPoint ICS code Option
  As a user I wants to plan my journey in London

  Background: Finding the ICS code of origin and destination
    Given I want to get Journey information from TFL by sending "GET" request to the end point "/kingcrossstation/to/luton" with following parameter
      |  |  |
      |  |  |
    And I get the ICS code of "London, Luton Station" as commonName from "toLocationDisambiguation" of the response body
